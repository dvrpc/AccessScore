...
// }
   ...
   // '#a50026',3,'#d73027',4,'#f46d43',5,'#fdae61',6,'#74add1',7,'#4575b4',8,'#313695',11,'#ccc'
    ...
    + "<td class='data-value'>"+numeral(props.npbper_va_).format("0.0%") +"</td>"
    + "<td class='data-value'>"+ numeral(props.npbper_va1).format("0.0%")+"</td>"
    + "<td class='data-value'>"+ numeral(props.npbper_v_1).format("0.0%") +"</td>"
    +"</tr>"
    +"<tr class='dataTable-row'>"
    ...
    +"<td class='data-value'>"+ numeral(props.tvv_va_a).format("(0,0)") +"</td>"
    +"<td class='data-value'>"+ numeral(props.tvv_va_c).format("(0,0)") +"</td>"
    +"<td class='data-value'>"+ numeral(props.tvv_va_w).format("(0,0)") +"</td>"
    +"</tr>"
    +"</table></div>";
