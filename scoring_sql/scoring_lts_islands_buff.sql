...
select
    ...
    civic_cnt as CIV_SM_C, --total number of civic resources within catchment area : NEEDS QUANTILE
    ...
    eta_cnt as ESS_SM_C, --total number of eta services within catchment area : NEEDS QUANTILE
    eta_score as ESS_SC_C, --eta quantile score
    emp_sum as EMP_SM_C, --total employees (Nets 2015) within catchment area : NEEDS QUANTILE
    employee_score as EMP_SC_C, --employee count quantile score
    ipd_score as IPD_SC_C, --IPD within catchment area (max value) --n/a (0), well below average (1), below average (2), average (3), abover average (4), well above average (5) 
    zerocar_sum as ZVH_SM_C, --Zero Vehicle Households (tract-level ASC 2019)  within catchment area : NEEDS QUANTILE
    zerocar_score as ZVH_SC_C, --Zero car quantile score
    pop_sum as POP_SM_C, --Total Population (tract-level ASC 2019) within catchment area : NEEDS QUANTILE
    pop_score as POP_SC_C, --Total population quantile score
    surv_count_C, --Count of most recent license plates within catchment area
    ...
    crash_tot_C, --Total 5 year crashes within catchment area
    ksi_tot as KSI_SM_C, --Total 5 year KSI crashes within catchment area
    ksi_score as KSI_SC_C, --Total 5 year KSI quantile score
    ksi_bike_tot_C, --Total 5 year KSI bike crashes within catchment area
    ksi_ped_tot_C, --Total 5 year KSI pedestrian crashes within catchment area
    ...
    lts_miles as LTS_VA_C, --miles of lts island in catchment area by station_id
    lts_score as LTS_SC_C, --lts quantile score
    ped_miles as PED_VA_C, --miles of ped network in catchment area by station_id
