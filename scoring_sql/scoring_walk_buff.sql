...
select
    ...
    civic_cnt as CIV_SM_W, --total number of civic resources within 1/2 mile : NEEDS QUANTILE
    ...
    eta_cnt as ESS_SM_W, --total number of eta services within 1/2 mile : NEEDS QUANTILE
    eta_score as ESS_SC_W, --eta quantile score
    emp_sum as EMP_SM_W, --total employees (Nets 2015) within 1-mile of the station : NEEDS QUANTILE
    ...
    zerocar_sum as ZVH_SM_W, --Zero Vehicle Households (tract-level ASC 2019)  within 1-mile of the station : NEEDS QUANTILE
    zerocar_score as ZVH_SC_W, --Zero car quantile score
    pop_sum as POP_SM_W, --Total Population (tract-level ASC 2019) within 1-mile of the station : NEEDS QUANTILE
    ...
    ksi_tot as KSI_SM_W, --Total 5 year KSI crashes within 2 miles of station
    ...
    lts_miles as LTS_VA_W, --miles of lts island in 2 mile buffer by station_id
    lts_score as LTS_SC_W, --lts quantile score
    ped_miles as PED_VA_W, --miles of ped network in 2 mile buffer by station_id
